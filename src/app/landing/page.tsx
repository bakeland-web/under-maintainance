    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 flex min-h-screen flex-col items-center justify-center px-4">
        ...
        <div className="mb-4 flex flex-col items-center">
          ...
          <div className="relative mb-2">
            <div className="relative">
              ...
              <div className="absolute inset-0 animate-pulse">
                <div className="h-64 w-[800px] rounded-lg bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 opacity-60 blur-sm md:h-72 md:w-[900px] lg:h-80 lg:w-[1000px]"></div>
              </div>
              ...
              <div className="relative flex items-center justify-center">
                <Image
                  ...
                  width={1200}
                  height={400}
                  className="h-64 w-auto md:h-100 lg:h-100 mb:0"
                  priority
                />
              </div>
            </div>
          ...
          <form onSubmit={handleEmailSubmit} className="flex flex-col items-center gap-1">
            ...
            <div className="w-30">
              <Button
                ...
                baseColor="wood"
                type="submit"
                className="w-full [&>div:last-child>div]:!px-0"
                disabled={isSubmitting}
              >
          ...
          <span className="self-center text-xl font-pixellari text-white-300 px-4 py-1 rounded-md [text-shadow:2px_2px_0_#fb923c,-2px_2px_0_#fb923c,2px_-2px_0_#fb923c,-2px_-2px_0_#fb923c]">
            get into bakeland
          </span>
        </div>
      </div>
